...
- (instancetype)initWithReuseIdentifier:(NSString *)reuseIdentifier{
    if (self = [super initWithReuseIdentifier:reuseIdentifier]) {
        ...
        self.sepLine = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, HXWIDTH, 0.5)];
        ...
        self.userNameLabel = [[UILabel alloc]initWithFrame:CGRectMake(CGRectGetMaxX(self.avatarIV.frame)+kGAP, kGAP,HXWIDTH-kAvatar_Size-2*kGAP-kGAP, self.avatarIV.frame.size.height/2)];
...
- (void)setModel:(MessageInfoModel2 *)model{
    ...
    self.commentBtn.frame = CGRectMake(HXWIDTH- commentBtnWidth-10, CGRectGetMaxY(self.jggView.frame)+3, commentBtnWidth, commentBtnHeight);
