...
-(instancetype)initWithDic:(NSDictionary *)dic{
    ...
    if (self) {
        ...
        if ([text.string isMoreThanOneLineWithSize:CGSizeMake(HXWIDTH - 2*kGAP-kAvatar_Size-10, CGFLOAT_MAX) font:font lineSpaceing:3.0]) {//margin
            style.lineSpacing = 3;
        }else{
        ...
        self.rowHeight = [text.string boundingRectWithSize:CGSizeMake(HXWIDTH - 2*kGAP-kAvatar_Size-10, CGFLOAT_MAX) font:font lineSpacing:3.0].height+0.5+3.0;//5.0为最后一行行间距
